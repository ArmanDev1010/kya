...
const AboutScroll = () => {
  return (
    <section
      className="flex gap-10 justify-center items-center p-[50px] bg-white relative flex-col my-0 mx-auto mt-10 max-tablet:py-0 max-tablet:!mt-4 mb-16 max-tablet:pr-[10px]
